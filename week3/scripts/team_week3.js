// Get your shorts on - this is an array workout!
      ...
      // 3. Sort the inventors by birthdate, oldest to youngest
        let inventorSort = inventors.sort(
            function (a, b) {
      ...
      // 4. How many years did all the inventors live?
        function total (death, birth) {
            return death - birth;
            };
            
        let inventorYearsLived = inventors.reduce((total,a) => total + a.passed - a.year,0); 
        console.log(inventorYearsLived); 

      // 5. Sort the inventors by years lived
        let inventorYearsSort = inventors.sort(
            function (a, b) {
                return (b.passed - b.year) - (a.passed - a.year);
            }
        );

        console.log(inventorYearsSort);
